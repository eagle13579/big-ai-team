...
from src.shared.model_selector import model_selector
...
def demo_roi_optimizer():
    ...
    test_tasks = [
        {"name": "简单问候", "task": "你好，请介绍一下你自己", "description": "简单对话任务"},
        {
            "name": "代码生成",
    ...
    for test_case in test_tasks:
        ...
        # 获取成本预估
        estimate = policy_tracker.estimate_cost(selected_model.name, 500, 1000)
