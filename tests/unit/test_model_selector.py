...
def test_complexity_estimation():
    ...
    test_cases = [
        ...
        (
            "请帮我开发一个完整的AI助手，需要包括登录注册、用户管理、数据存储、数据分析等功能，还要考虑性能优化和安全性，写一个详细的技术方案",
...
def test_model_selection():
    ...
    for task in test_cases:
        ...
        print(
            f"成本: {'免费 🆓' if selected_model.cost_per_1k_tokens == 0 else f'${selected_model.cost_per_1k_tokens * 1000:.2f} 每百万 token'}"
        )
