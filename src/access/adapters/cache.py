...
class CacheAdapter(BaseAdapter[Dict[str, Any]]):
    ...
    @abstractmethod
    async def get(self, params: Dict[str, Any], context: Optional[AdapterContext] = None) -> Dict[str, Any]:
        """获取缓存"""
        pass
    
    @abstractmethod
    async def set(self, params: Dict[str, Any], context: Optional[AdapterContext] = None) -> Dict[str, Any]:
        """设置缓存"""
        pass
