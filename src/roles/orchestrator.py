...
class PlanningOrchestrator:
    ...
    def _decompose_task(
        ...
        if task_type == "coding":
            subtasks = [
                {"id": "1", "description": "分析代码需求", "type": "analysis", "priority": "high"},
                {"id": "2", "description": "编写代码", "type": "coding", "priority": "high"},
                {"id": "3", "description": "测试代码", "type": "testing", "priority": "medium"},
                {"id": "4", "description": "提交代码", "type": "git", "priority": "medium"},
            ]
        elif task_type == "analysis":
            subtasks = [
                {"id": "1", "description": "收集信息", "type": "research", "priority": "high"},
                {"id": "2", "description": "分析数据", "type": "analysis", "priority": "high"},
                {
                    "id": "3",
                    "description": "生成报告",
                    "type": "documentation",
            ...
            subtasks = [
                {"id": "1", "description": "收集文档需求", "type": "analysis", "priority": "high"},
                {"id": "2", "description": "编写文档", "type": "documentation", "priority": "high"},
                {"id": "3", "description": "审查文档", "type": "review", "priority": "medium"},
            ]
        else:
            # 通用任务
            subtasks = [
                {"id": "1", "description": "执行任务", "type": "general", "priority": "high"},
                {"id": "2", "description": "验证结果", "type": "review", "priority": "medium"},
            ]
    ...
    def _assign_tasks(self, subtasks: list[dict[str, Any]]) -> list[dict[str, Any]]:
        ...
        for subtask in subtasks:
            ...
            assigned_task = {**subtask, "assigned_role": role_type}
        ...
        for task in assigned_tasks:
            ...
            if not role:
                execution_results.append(
                    {
                        "task": task,
                        "result": {"status": "error", "message": f"无法创建角色: {role_type}"},
                    }
                )
                continue
                ...
                review_results.append(
                    {
                        "task": execution["task"],
                        "execution_result": execution["result"],
                        "review_result": {"status": "error", "message": "执行失败，无需审查"},
                    }
                )
