...
class MemPalaceIntegrationV2:
                ...
                with open(self.versions_file, "r", encoding="utf-8") as f:
                    ...
                    for memory_id, versions in data.items():
                        self.versions[memory_id] = [
                            MemoryVersion(**v) for v in versions
                        ]
    ...
    def _add_version(self, memory_id: str, content: str, context: Dict[str, Any], 
                     change_type: str, changes: List[str]):
        """添加记忆版本"""
    ...
    def _find_similar_memories(self, content: str, threshold: float = None) -> List[Tuple[str, float]]:
        """查找相似记忆"""
    ...
    def _merge_contexts(self, old_context: Dict[str, Any], 
                        new_context: Dict[str, Any]) -> Tuple[Dict[str, Any], List[str]]:
        """智能合并上下文"""
    ...
    def add_memory(self, content: str or Dict[str, Any], 
            ...
            try:
                ...
                if duplicate_id:
                    ...
                    return self._update_existing_memory(
                        duplicate_id, content, context, tags
                    )
    ...
    def _create_new_memory(self, content: str, context: Dict[str, Any], 
    ...
    def _update_existing_memory(self, memory_id: str, content: str, 
                                context: Dict[str, Any], tags: List[str]) -> Dict[str, Any]:
        """更新现有记忆"""
        # 查找记忆
        memory = None
        current_tier = None
    ...
    def _evaluate_memory_quality(self, memory_id: str, content: str, 
                                  context: Dict[str, Any]) -> MemoryQualityMetrics:
        """评估记忆质量"""
    ...
    def _update_knowledge_graph(self, memory_id: str, content: str, 
    ...
    def search(self, query: str, limit: int = 5, 
        ...
        try:
            ...
            # 上下文排序
            if context:
                ranked_results = self._sort_by_context_relevance(
                    ranked_results, context
                )
    ...
    def _merge_search_results(self, vector_results: List[Dict], 
                              traditional_results: List[Dict]) -> List[Dict]:
        """合并搜索结果"""
        memory_ids = set()
        merged = []
    ...
    def _sort_by_context_relevance(self, results: List[Dict], 
        ...
        results.sort(key=lambda x: (x.get("context_score", 0), 
    ...
    def get_memory_stats(self) -> Dict[str, Any]:
        ...
        stats["cluster_stats"] = {
            ...
            "average_size": sum(len(m) for m in self.clusters.values()) / len(self.clusters) if self.clusters else 0
        }
