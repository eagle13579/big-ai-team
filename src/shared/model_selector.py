...
try:
    from .model_policy_tracker import policy_tracker, CostEstimate
...
class ModelSelector:
    ...
    def __init__(self):
        ...
        self.models = {
            ...
            "ollama-llama3": ModelInfo(
                ...
                capabilities=["text_generation", "analysis", "reasoning", "code_generation", "summary"],
                max_tokens=8192,
                recommended_for=[TaskType.TEXT_GENERATION, TaskType.ANALYSIS, TaskType.SUMMARY, TaskType.CODE_GENERATION]
            ),
            "ollama-qwen2.5": ModelInfo(
                name="ollama-qwen2.5",
                provider="ollama",
                cost_per_1k_tokens=0.0,  # 完全免费！本地运行
                capabilities=["text_generation", "analysis", "reasoning", "code_generation", "translation", "creative_writing"],
                max_tokens=128000,
                recommended_for=[TaskType.TEXT_GENERATION, TaskType.ANALYSIS, TaskType.REASONING, TaskType.CODE_GENERATION, TaskType.TRANSLATION]
            ),
            "ollama-mistral": ModelInfo(
                ...
                max_tokens=32768,
                recommended_for=[TaskType.TEXT_GENERATION, TaskType.ANALYSIS, TaskType.CODE_GENERATION, TaskType.SUMMARY]
            ),
            ...
            "deepseek-chat": ModelInfo(
                ...
                max_tokens=128000,
                recommended_for=[TaskType.TEXT_GENERATION, TaskType.ANALYSIS, TaskType.SUMMARY, TaskType.TRANSLATION]
            ),
            ...
            "claude-3-5-sonnet-latest": ModelInfo(
                ...
                capabilities=["text_generation", "analysis", "reasoning", "creative_writing", "summary"],
                max_tokens=200000,
                recommended_for=[TaskType.ANALYSIS, TaskType.REASONING, TaskType.CREATIVE_WRITING, TaskType.SUMMARY]
            ),
            "gpt-4o-mini": ModelInfo(
                ...
                capabilities=["text_generation", "analysis", "reasoning", "code_generation", "summary"],
                max_tokens=128000,
                recommended_for=[TaskType.ANALYSIS, TaskType.REASONING, TaskType.CODE_GENERATION, TaskType.SUMMARY]
            ),
            ...
            "gpt-4o-2026": ModelInfo(
                ...
                capabilities=["text_generation", "analysis", "reasoning", "code_generation", "creative_writing", "search"],
                max_tokens=128000,
                recommended_for=[TaskType.REASONING, TaskType.CODE_GENERATION, TaskType.CREATIVE_WRITING, TaskType.SEARCH]
            ),
            "gemini-1.5-pro": ModelInfo(
                name="gemini-1.5-pro",
                provider="google",
                cost_per_1k_tokens=0.0035,  # $3.5 每百万 token
                capabilities=["text_generation", "analysis", "reasoning", "code_generation", "creative_writing", "multimodal"],
                max_tokens=1000000,
                recommended_for=[TaskType.REASONING, TaskType.CODE_GENERATION, TaskType.CREATIVE_WRITING]
            ),
            ...
            "glm-4": ModelInfo(
                ...
                max_tokens=128000,
                recommended_for=[TaskType.TEXT_GENERATION, TaskType.ANALYSIS, TaskType.REASONING, TaskType.CODE_GENERATION]
            ),
            "glm-4-flash": ModelInfo(
                ...
                capabilities=["text_generation", "analysis", "reasoning", "code_generation", "translation", "creative_writing"],
                max_tokens=128000,
                recommended_for=[TaskType.TEXT_GENERATION, TaskType.ANALYSIS, TaskType.REASONING, TaskType.CODE_GENERATION, TaskType.TRANSLATION, TaskType.CREATIVE_WRITING]
            )
        }
    ...
    def select_model(
        ...
        for model_info in self.models.values():
            # 检查模型是否推荐用于该任务类型
            if task_type in model_info.recommended_for or task_type.value in model_info.capabilities:
                # 检查预算限制
        ...
        # 模型质量评估
        def evaluate_model_quality(model: ModelInfo, task_type: TaskType, complexity: ComplexityLevel) -> float:
            """
        ...
        if POLICY_TRACKER_AVAILABLE and warn_before_pay:
            ...
            if not estimate.is_free:
                logger.warning(f"💰 成本预估: 使用 {selected_model.name} 约需 ${estimate.estimated_cost:.4f}")
                if estimate.warning:
    ...
    def get_cost_estimate(
        ...
        """
        if POLICY_TRACKER_AVAILABLE:
            return policy_tracker.estimate_cost(model_name, estimated_input_tokens, estimated_output_tokens)
        return None
    ...
    def should_ask_user_before_execution(
        ...
        """
        if POLICY_TRACKER_AVAILABLE:
            return policy_tracker.should_ask_user(model_name, estimated_input_tokens, estimated_output_tokens)
        return False
